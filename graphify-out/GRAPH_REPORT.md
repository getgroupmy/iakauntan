...
## Corpus Check
- 345 files · ~398,989 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5659 nodes · 8302 edges · 339 communities (300 shown, 39 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f03fe18e`
...
Cohesion: 0.03
Nodes (75): corpBeneficialOwnersProvider, corpChargesProvider, corpDocumentsProvider, corpMembersProvider, corpOfficersProvider, corpShareEventsProvider, corpSignaturesProvider, corpTemplatesProvider (+67 more)
...
Cohesion: 0.04
Nodes (57): agedBalancesProvider, attendanceProvider, auditPayslip, authStateProvider, bankTransfersProvider, build, canReadLedgerProvider, clear (+49 more)
...
Cohesion: 0.08
Nodes (24): _activity, _amount, _billable, canPost, _ClientMoneyDialog, _ClientMoneyDialogState, createState, _date (+16 more)
...
Cohesion: 0.07
Nodes (34): payslipAccessLogProvider, payslipAccessRequestsProvider, teamProvider, TeamMember, _GrantedBadge, _AccessLog, _AccessLogState, _AccessRow (+26 more)
...
Cohesion: 0.07
Nodes (30): DeclaredRelief, _amount, _c, _code, createState, _ctl, dispose, _edit (+22 more)
...
Cohesion: 0.06
Nodes (37): classificationCodesProvider, itemsProvider, taxCodesProvider, build, LineEditorCard, _ItemDialogState, build, _classification (+29 more)
...
Cohesion: 0.07
Nodes (36): currentOrgIdProvider, isPlatformAdminProvider, memberRoleProvider, organizationsProvider, _AuthRefresh, Organization, _create, SettingsScreen (+28 more)

### Community 40 - "platform_console_screen.dart"
Cohesion: 0.09
Nodes (24): platformRepoProvider, PlatformOrg, _sell, _controller, createState, _dirty, dispose, _encode (+16 more)
...
Cohesion: 0.09
Nodes (21): _Banner, _Brand, build, _busy, color, createState, _demoBusy, dispose (+13 more)
...
Cohesion: 0.09
Nodes (26): canAdminProvider, emailOutboxProvider, emailSettingsProvider, build, _busy, createState, _days, dispose (+18 more)
...
Cohesion: 0.11
Nodes (19): _asAt, base, _board, _c, createState, currency, date, dispose (+11 more)
...
Cohesion: 0.06
Nodes (34): _block, buildPayslipPdf, deductions, earnings, employer, kit, mode, pdf (+26 more)
...
Cohesion: 0.15
Nodes (12): bytes, docScannerLikely, isScannerUnavailable, path, scanDocumentPage, ScannedPage, onDeviceReaderAvailable, readTextFromBytes (+4 more)
...
Cohesion: 0.10
Nodes (23): build, error, main, _StartupFailure, main, everything, harness, main (+15 more)
...
### Community 119 - "../../core/theme.dart"
Cohesion: 0.09
Nodes (22): build, IAkauntanApp, passwordRecoveryProvider, routerProvider, _abandon, _busy, _confirm, createState (+14 more)
...
Cohesion: 0.06
Nodes (23): Amount,Particulars,Posting, main, main, line, main, main, band, main (+15 more)

### Community 211 - "ConsumerWidget"
Cohesion: 0.09
Nodes (29): applicantsProvider, appraisalsProvider, platformModulesProvider, platformOrgsProvider, platformSettingsProvider, platformStatsProvider, requisitionsProvider, build (+21 more)

### Community 212 - "build"
Cohesion: 0.22
Nodes (10): currenciesProvider, customerCreditProvider, projectsProvider, salespeopleProvider, build, _CreditBanner, _CurrencyField, _HeaderCard (+2 more)
...
Cohesion: 0.04
Nodes (54): AsyncView, _DeltaBadge, EmptyState, ErrorState, FilterBar, Money, PageBody, SectionHeader (+46 more)
...
### Community 232 - "_EmployeeEditorState"
Cohesion: 0.32
...
Cohesion: 0.08
Nodes (26): settlementProvider, settlementsProvider, _attach, _body, build, _busy, createState, defaultTo (+18 more)
...
### Community 271 - "List"
Cohesion: 0.25
Nodes (7): canPost, _CertificateTile, _LatePanel, _remit, row, rows, List
...
### Community 278 - "supabaseProvider"
Cohesion: 0.10
Nodes (22): currentUserProvider, enabledModulesProvider, fiscalYearsProvider, isDemoAccountProvider, moduleEnabled, select, supabaseProvider, build (+14 more)
...
Cohesion: 0.06
Nodes (32): attachmentId, b, bytes, cameraLikely, captureAndRead, CapturedFile, CaptureSource, file (+24 more)

### Community 283 - "../../core/providers.dart"
Cohesion: 0.22
...
Cohesion: 0.11
Nodes (23): canPostProvider, expensesProvider, journalSourceFilterProvider, journalsProvider, recurringJournalsProvider, withholdingReportProvider, JournalEntry, build (+15 more)
...
Cohesion: 0.17
Nodes (16): canWriteProvider, clientTransactionsProvider, disbursementsProvider, mattersProvider, matterSummaryProvider, timeEntriesProvider, build, build (+8 more)
...
Cohesion: 0.11
Nodes (16): OcrExtraction, bold, build, canApply, label, read, _Row, _ScanResultDialog (+8 more)
...
### Community 323 - "repoProvider"
Cohesion: 0.05
Nodes (68): accountsProvider, repoProvider, PlatformConsoleScreen, _PlatformConsoleScreenState, _PublishDialog, _PublishDialogState, ReconciliationScreen, _ReconciliationScreenState (+60 more)
...
## Knowledge Gaps
- **2969 isolated node(s):** `XCTest`, `error`, `main`, `build`, `out` (+2964 more)
...
- **Why does `repoProvider` connect `repoProvider` to `VoidCallback`, `currentOrgProvider`, `document_editor.dart`, `hr_setup_screen.dart`, `entity_screen.dart`, `providers.dart`, `payroll_screen.dart`, `matter_detail_screen.dart`, `List`, `team_screen.dart`, `attachments_card.dart`, `tax_year_section.dart`, `contact_editor.dart`, `settlement_dialog.dart`, `supabaseProvider`, `../../core/providers.dart`, `pipeline_screen.dart`, `items_screen.dart`, `claims_screen.dart`, `../../core/widgets.dart`, `settings_screen.dart`, `einvoice_screen.dart`, `build`, `leave_screen.dart`, `journal_editor.dart`, `_TaxYearSectionState`, `reconciliation_screen.dart`, `email_dialog.dart`, `recurring_screen.dart`, `salespeople_screen.dart`, `contact_extras.dart`, `_ContactEditorState`, `expenses_screen.dart`, `DateTime`, `employee_records.dart`, `item_prices_dialog.dart`, `documents/transfer_dialog.dart`, `statutory_rates_admin.dart`, `email_screen.dart`, `withholding_dialog.dart`, `leave_bands_dialog.dart`, `stock_take_screen.dart`, `exchange_rates_screen.dart`, `leads_screen.dart`, `holidays_tab.dart`, `ConsumerWidget`, `asset_editor.dart`, `onboarding_template_dialog.dart`, `share_dialog.dart`, `appraisal_goals_dialog.dart`, `onboarding_screen.dart`, `my_hr_screen.dart`, `lot_dialog.dart`, `lots_screen.dart`, `banking/transfer_dialog.dart`, `repeat_dialog.dart`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `_` connect `_` to `package:flutter/material.dart`, `dashboard_screen.dart`, `static const`, `_`, `AppColors`?**
...
- **Should `document_editor.dart` be split into smaller, more focused modules?**
