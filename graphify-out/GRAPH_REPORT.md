...
## Corpus Check
- 210 files · ~204,989 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3507 nodes · 5147 edges · 218 communities (190 shown, 28 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `af37bdbc`
...
## Communities (218 total, 28 thin omitted)
...
Cohesion: 0.07
Nodes (35): clientTransactionsProvider, disbursementsProvider, mattersProvider, timeEntriesProvider, _activity, _amount, _billable, build (+27 more)
...
Cohesion: 0.06
Nodes (42): repoProvider, requireRepo, PayslipAccessRequest, TeamMember, _load, _post, _resolveRate, _storeRate (+34 more)
...
Cohesion: 0.11
Nodes (15): doc, main, _line, main, asAt, doc, main, package:iakauntan/src/core/download.dart (+7 more)
...
Cohesion: 0.07
Nodes (34): canWriteProvider, contactsProvider, currenciesProvider, matterSummaryProvider, opportunitiesProvider, pipelineStagesProvider, Opportunity, PipelineStage (+26 more)
...
Cohesion: 0.07
Nodes (32): platformModulesProvider, platformOrgsProvider, platformRepoProvider, platformSettingsProvider, platformStatsProvider, PlatformOrg, build, _controller (+24 more)
...
### Community 69 - "currentOrgIdProvider"
Cohesion: 0.19
Nodes (15): currentOrgIdProvider, isPlatformAdminProvider, memberRoleProvider, organizationsProvider, _AuthRefresh, _create, SettingsScreen, _AccountButton (+7 more)
...
Cohesion: 0.12
Nodes (22): canPostProvider, payslipAccessLogProvider, PlatformConsoleScreen, _PlatformConsoleScreenState, ContactEditor, DocumentEditor, _DocumentEditorState, _RequestAccessScreen (+14 more)
...
Cohesion: 0.11
Nodes (24): corpBeneficialOwnersProvider, corpChargesProvider, corpDocumentsProvider, corpMembersProvider, corpShareEventsProvider, corpSignaturesProvider, corpTemplatesProvider, payslipAccessRequestsProvider (+16 more)
...
Cohesion: 0.29
Nodes (10): accountsProvider, bankAccountsProvider, paymentModesProvider, build, _SettlementDialog, _SettlementDialogState, build, _ExpenseDialog (+2 more)

### Community 176 - "build"
Cohesion: 0.16
Nodes (16): canAdminProvider, currentUserProvider, enabledModulesProvider, fiscalYearsProvider, isDemoAccountProvider, moduleEnabled, select, teamProvider (+8 more)
...
Cohesion: 0.22
Nodes (8): Built in the database, unreachable from the app, Gaps against AutoCount Accounting 2.0, Migration eligibility, Not in the schema at all, The finding that matters most, The order to build in, What iAkauntan has that AutoCount does not, What was read, and what was not
...
Cohesion: 0.11
Nodes (16): main, pump, main, filters, main, phone, pump, main (+8 more)
...
### Community 205 - "../../core/widgets.dart"
Cohesion: 0.18
...
Cohesion: 0.29
Nodes (7): build, IAkauntanApp, routerProvider, ../../core/env.dart, core/router.dart, ../../core/theme.dart, package:flutter/material.dart

### Community 212 - "_ReportsScreenState"
Cohesion: 0.33
Nodes (6): trialBalanceProvider, _balanceSheetProvider, _profitLossProvider, ReportsScreen, _ReportsScreenState, _sstProvider

### Community 213 - "../../core/format.dart"
Cohesion: 0.33
...
### Community 215 - "_OpenDocumentsState"
Cohesion: 0.67
Nodes (3): outstandingProvider, _OpenDocuments, _OpenDocumentsState

### Community 216 - "payslipProvider"
Cohesion: 0.67
...
## Knowledge Gaps
- **1791 isolated node(s):** `XCTest`, `error`, `main`, `build`, `false` (+1786 more)
...
- **Why does `_` connect `_` to `../../data/models.dart`, `payslip_pdf.dart`, `statement_pdf.dart`, `dart:typed_data`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `repoProvider` connect `repoProvider` to `hr_setup_screen.dart`, `entity_screen.dart`, `providers.dart`, `matter_detail_screen.dart`, `tax_year_section.dart`, `contact_editor.dart`, `settlement_dialog.dart`, `pipeline_screen.dart`, `items_screen.dart`, `claims_screen.dart`, `settings_screen.dart`, `einvoice_screen.dart`, `leave_screen.dart`, `attachments_card.dart`, `_ExpenseDialogState`, `matters_screen.dart`, `build`, `build`, `expenses_screen.dart`, `../../core/providers.dart`, `taxCodesProvider`, `currentOrgProvider`, `ConsumerState`, `_RequestLeaveDialogState`, `../../core/format.dart`, `my_hr_screen.dart`, `ConsumerWidget`?**
