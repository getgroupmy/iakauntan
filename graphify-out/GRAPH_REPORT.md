...
## Corpus Check
- 312 files · ~344,962 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5111 nodes · 7551 edges · 312 communities (275 shown, 37 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 3 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `59ed67e7`
...
1. `repoProvider` - 180 edges
2. `_` - 44 edges
3. `canWriteProvider` - 34 edges
4. `_` - 31 edges
5. `canPostProvider` - 28 edges
6. `_` - 27 edges
7. `currentOrgProvider` - 25 edges
...
Cohesion: 0.01
Nodes (243): acceptInvitation, accounts, activities, addDisbursement, addFixedHolidays, addTimeEntry, agedBalances, amIPlatformAdmin (+235 more)
...
Cohesion: 0.07
Nodes (48): BNM_HEADERS, BnmRow, Quote, SESSIONS, cancel(), checkStatus(), submit(), ID_TYPES (+40 more)

### Community 4 - "document_editor.dart"
Cohesion: 0.02
Nodes (93): _actions, _base, baseCurrency, caption, _changeCurrency, _contactId, controller, createState (+85 more)
...
Cohesion: 0.05
Nodes (43): payrollSettingsProvider, setupRowsProvider, _blank, boolean, build, _c, createState, _ctl (+35 more)
...
Cohesion: 0.04
Nodes (52): agedBalancesProvider, attendanceProvider, auditPayslip, authStateProvider, bankTransfersProvider, build, canReadLedgerProvider, clear (+44 more)
...
Cohesion: 0.07
Nodes (33): canAdminProvider, payslipAccessLogProvider, payslipAccessRequestsProvider, teamProvider, TeamMember, _GrantedBadge, _AccessLog, _AccessLogState (+25 more)

### Community 17 - "attachments_card.dart"
Cohesion: 0.10
Nodes (21): Attachment, AttachmentsCard, _AttachmentsCardState, attachmentsProvider, build, _busy, canWrite, createState (+13 more)
...
Cohesion: 0.07
Nodes (30): _build, _c, contactId, contactType, _controllers, createState, dispose, _entityType (+22 more)

### Community 23 - "settlement_dialog.dart"
Cohesion: 0.05
Nodes (40): _allocated, _allocatedDocs, _AllocationRow, _AllocationRowState, _allocations, amount, _bankAccountId, _bankCharges (+32 more)
...
Cohesion: 0.07
Nodes (35): trialBalanceProvider, ReportSpec, _aged, _agedProvider, _balanceSheetProvider, _Block, build, _cashFlowProvider (+27 more)
...
### Community 36 - "ConsumerStatefulWidget"
Cohesion: 0.04
Nodes (59): fxRevaluationPreviewProvider, FiscalYear, FxRevaluation, ContactEditor, DocumentEditor, _DocumentDialog, _DocumentEditor, _SettingsTab (+51 more)
...
Cohesion: 0.07
Nodes (34): currentOrgIdProvider, isPlatformAdminProvider, organizationsProvider, _AuthRefresh, Organization, _create, AppShell, _bareLayout (+26 more)

### Community 40 - "platform_console_screen.dart"
Cohesion: 0.05
Nodes (44): platformRepoProvider, PlatformOrg, _controller, createState, _dirty, dispose, _encode, initState (+36 more)
...
Cohesion: 0.09
Nodes (22): salespeopleProvider, _active, base, build, _code, createState, dispose, _edit (+14 more)
...
Cohesion: 0.11
Nodes (20): expensesProvider, paymentModesProvider, _accountId, _amount, _bankAccountId, build, createState, _date (+12 more)
...
Cohesion: 0.06
Nodes (33): canTransfer, description, build, _controller, createState, dispose, initState, line (+25 more)

### Community 64 - "email_screen.dart"
Cohesion: 0.09
Nodes (24): emailOutboxProvider, emailSettingsProvider, build, _busy, createState, _days, dispose, EmailScreen (+16 more)
...
Cohesion: 0.11
Nodes (26): public.email_settings, app.advance_recurring_document(), app.post_sales_document_internal(), app.queue_document_email(), app.queue_overdue_reminders(), app.raise_recurring_document(), app.run_recurring_documents(), app.snapshot_document() (+18 more)

### Community 82 - "../../core/format.dart"
Cohesion: 0.07
Nodes (35): build, IAkauntanApp, depreciationPreviewProvider, routerProvider, Employee, JournalEntry, LeaveBalance, _asAt (+27 more)
...
### Community 136 - "State"
Cohesion: 0.16
Nodes (16): _PasteDialog, _PasteDialogState, _PersonDialog, _LineRow, _LineRowState, _FillGaps, _FillGapsState, _SignatoryPicker (+8 more)
...
Cohesion: 0.07
Nodes (32): contactAddressesProvider, contactPersonsProvider, _AddressDialog, _AddressDialogState, _AddressTile, build, _c, ContactExtras (+24 more)
...
### Community 191 - "canManageHrProvider"
Cohesion: 0.20
...
Cohesion: 0.05
Nodes (36): _AdminScheduleTile, _body, byCategory, category, createState, dispose, _employee, employeeAmount (+28 more)

### Community 193 - "0095_outbound_email.sql"
Cohesion: 0.17
Nodes (14): public.platform_settings, app.document_email_vars(), app.issue_share_token(), app.queue_overdue_reminders(), app.share_url(), public.email_document(), public.email_outbox, public.email_settings (+6 more)
...
### Community 203 - "canWriteProvider"
Cohesion: 0.19
Nodes (14): canWriteProvider, clientTransactionsProvider, contactsProvider, disbursementsProvider, matterSummaryProvider, timeEntriesProvider, build, build (+6 more)
...
Cohesion: 0.09
Nodes (17): Amount,Particulars,Posting, main, main, line, main, main, band, main (+9 more)
...
Cohesion: 0.18
Nodes (11): Contact, contact, ContactsScreen, _ContactsScreenState, _ContactTile, createState, dispose, _query (+3 more)

### Community 222 - "../../data/repository.dart"
Cohesion: 0.18
Nodes (12): applicantsProvider, appraisalsProvider, requisitionsProvider, _advance, _AppraisalsTab, build, _RequisitionsTab, _stages (+4 more)
...
### Community 235 - "DateTime"
Cohesion: 0.13
Nodes (14): attachments, attachmentUrl, bucket, createdAt, deleteAttachment, fileName, fileSize, fromJson (+6 more)

### Community 238 - "repoProvider"
Cohesion: 0.11
Nodes (34): currentOrgProvider, myAttendanceTodayProvider, myEmployeeProvider, myPayslipsProvider, orgLogoProvider, repoProvider, _ContactEditorState, _downloadStatement (+26 more)
...
Cohesion: 0.15
Nodes (12): contrast, main, main, pump, filters, main, phone, pump (+4 more)
...
### Community 248 - "banking/transfer_dialog.dart"
Cohesion: 0.13
...
### Community 252 - "accountsProvider"
Cohesion: 0.18
Nodes (12): accountsProvider, projectsProvider, recurringJournalsProvider, _HeaderCard, build, _JournalEditor, _JournalEditorState, build (+4 more)

### Community 253 - "disposal_dialog.dart"
Cohesion: 0.10
Nodes (20): bankAccountsProvider, outstandingProvider, FixedAsset, asset, _bankAccountId, build, createState, _DisposalDialog (+12 more)
...
Cohesion: 0.15
Nodes (14): recurringDocumentsProvider, build, _busy, canPost, createState, _delete, onChanged, RecurringDocumentsScreen (+6 more)
...
### Community 268 - "canPostProvider"
Cohesion: 0.31
Nodes (9): canPostProvider, journalSourceFilterProvider, journalsProvider, withholdingReportProvider, build, WithholdingScreen, _ClaimTile, build (+1 more)
...
Cohesion: 0.22
Nodes (8): 1. A Resend account and a verified domain, 2. The secrets, 3. Deploy the function, 4. Drain the queue on a schedule, 5. Switch it on per company, Turning email on, What is already in place, What to check first when nothing arrives

### Community 271 - "package:iakauntan/src/data/models.dart"
Cohesion: 0.14
Nodes (11): asset, main, doc, main, _line, main, package:iakauntan/src/core/download.dart, package:iakauntan/src/core/layout.dart (+3 more)
...
### Community 281 - "build"
Cohesion: 0.20
Nodes (12): currentUserProvider, fiscalYearsProvider, isDemoAccountProvider, memberRoleProvider, select, build, _save, _AboutCard (+4 more)

### Community 282 - "employeesProvider"
Cohesion: 0.33
...
### Community 284 - "_StockTakeScreenState"
Cohesion: 0.40
Nodes (6): stockOnHandProvider, warehousesProvider, build, _post, StockTakeScreen, _StockTakeScreenState
...
### Community 290 - "List"
Cohesion: 0.12
Nodes (15): canPost, _CertificateTile, _LatePanel, _remit, row, rows, _bodies, bodyName (+7 more)

### Community 291 - "ConsumerState"
Cohesion: 0.14
Nodes (15): _TransferDialogState, _PersonDialogState, _PersonDialogState, SharedDocumentPage, _SharedDocumentPageState, _TransferDialogState, _DocumentDialogState, _SetupDialog (+7 more)
...
### Community 299 - "_EmployeeEditorState"
Cohesion: 0.32
...
### Community 303 - "statement_test.dart"
Cohesion: 0.29
...
### Community 308 - "mattersProvider"
Cohesion: 0.50
Nodes (4): mattersProvider, initState, _TimeDialog, _TimeDialogState

## Knowledge Gaps
- **2643 isolated node(s):** `XCTest`, `error`, `main`, `build`, `out` (+2638 more)
...
- **Why does `repoProvider` connect `repoProvider` to `VoidCallback`, `document_editor.dart`, `hr_setup_screen.dart`, `entity_screen.dart`, `providers.dart`, `canPostProvider`, `payroll_screen.dart`, `build`, `matter_detail_screen.dart`, `team_screen.dart`, `attachments_card.dart`, `tax_year_section.dart`, `contact_editor.dart`, `settlement_dialog.dart`, `build`, `_StockTakeScreenState`, `pipeline_screen.dart`, `items_screen.dart`, `claims_screen.dart`, `List`, `ConsumerState`, `taxCodesProvider`, `ConsumerStatefulWidget`, `einvoice_screen.dart`, `build`, `platform_console_screen.dart`, `journal_editor.dart`, `leave_screen.dart`, `_TaxYearSectionState`, `reconciliation_screen.dart`, `recurring_screen.dart`, `matters_screen.dart`, `import_screen.dart`, `mattersProvider`, `_PublishDialogState`, `salespeople_screen.dart`, `contact_extras.dart`, `employee_records.dart`, `expenses_screen.dart`, `item_prices_dialog.dart`, `documents/transfer_dialog.dart`, `statutory_rates_admin.dart`, `email_screen.dart`, `withholding_dialog.dart`, `leave_bands_dialog.dart`, `exchange_rates_screen.dart`, `leads_screen.dart`, `holidays_tab.dart`, `../../core/format.dart`, `build`, `../../data/repository.dart`, `asset_editor.dart`, `onboarding_template_dialog.dart`, `share_dialog.dart`, `appraisal_goals_dialog.dart`, `onboarding_screen.dart`, `lot_dialog.dart`, `banking/transfer_dialog.dart`, `accountsProvider`, `disposal_dialog.dart`, `repeat_dialog.dart`?**
...
- **Should `repository.dart` be split into smaller, more focused modules?**
  _Cohesion score 0.00819672131147541 - nodes in this community are weakly interconnected._
