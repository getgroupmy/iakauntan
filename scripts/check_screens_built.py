...
# go straight to it.
EXEMPT: dict[str, str] = {
    'BudgetsScreen': 'lib/src/features/reports/budgets_screen.dart',
    ...
    'ExpensesScreen': 'lib/src/features/expenses/expenses_screen.dart',
    'FilingScreen': 'lib/src/features/financials/filing_screen.dart',
    'FilingsScreen': 'lib/src/features/financials/filings_screen.dart',
    'HrSetupScreen': 'lib/src/features/hr/hr_setup_screen.dart',
    'KnockOffScreen': 'lib/src/features/documents/knock_off_screen.dart',
    'LandedCostScreen': 'lib/src/features/stock/landed_cost_screen.dart',
    'LeadsScreen': 'lib/src/features/crm/leads_screen.dart',
    'MattersScreen': 'lib/src/features/legal/matters_screen.dart',
    'MenuLinksScreen': 'lib/src/features/pos/menu_links_screen.dart',
    'MenuTimesScreen': 'lib/src/features/pos/menu_times_screen.dart',
    'NoAccessScreen': 'lib/src/features/landing/no_access_screen.dart',
    ...
    'PipelineScreen': 'lib/src/features/crm/pipeline_screen.dart',
    'ProfileScreen': 'lib/src/features/profile/profile_screen.dart',
    'PromotionsScreen': 'lib/src/features/pos/promotions_screen.dart',
    'PropertyScreen': 'lib/src/features/property/property_screen.dart',
    'RecipesScreen': 'lib/src/features/pos/recipes_screen.dart',
    'RecurringScreen': 'lib/src/features/ledger/recurring_screen.dart',
    'ScalesScreen': 'lib/src/features/pos/scales_screen.dart',
    'StallsScreen': 'lib/src/features/pos/stalls_screen.dart',
    'StockTakeScreen': 'lib/src/features/stock/stock_take_screen.dart',
    'TicketScreen': 'lib/src/features/ticketing/ticket_screen.dart',
    'TicketTeamsScreen': 'lib/src/features/ticketing/teams_screen.dart',
    'TicketsScreen': 'lib/src/features/ticketing/tickets_screen.dart',
