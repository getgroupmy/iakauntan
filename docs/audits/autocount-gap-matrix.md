...
| 6 | ~~**G6 transaction import**~~ — **sales and purchase BUILT**, `0631`/`0632`; JOURNAL import still to do | Opening balances already import as open items, which was the migration blocker. Invoice and journal import is a convenience after that, and matters most in the first week of a new customer | M |
