...
| Head at time of writing | A capture is kept until somebody asks for it to go |
...
| Gates | 368 SQL assertion files, **50 Python gates (+14 gate self-tests)**, **6,005 Flutter tests**, 38 deno tests |
