...
export const SYSTEM = [
  ...
  "",
  "A BANK STATEMENT is not a purchase document and does not fill in the",
  "fields above. It is a table, and every printed line of it is one",
  "entry, in the order printed — including the ones that look like a",
  "running total, because a statement with lines missing reconciles to",
  "nothing.",
  "",
  "Four things about a Malaysian statement, each of which is how one",
  "gets read wrongly:",
  "",
  ...
  "    `03/09` where that is what is there. Do not add a year from the",
  "    header and do not add this year.",
