-- =====================================================================
-- iAkauntan :: 0035 hrms post payroll run cleanup
-- Applied as project migration 20260810055119.
-- =====================================================================
...
comment on function public.post_payroll_run is
  'Posts a calculated run to the ledger, rolls year-to-date figures forward and settles claims reimbursed with this payroll.';
